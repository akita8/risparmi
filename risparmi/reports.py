import npyscreen
from popups import SingleReportPopup, ResultDisplay
import misc
...
class ValorizationVisualization(npyscreen.Form): #temporanea
    ...
    def create(self):
        ...
        a_values=misc.formatted_values(self.parentApp.myRisparmi.stock_val_account)
        ...
        s_values=misc.formatted_values(self.parentApp.myRisparmi.stock_val_sector)
        ...
        c_values=misc.formatted_values(self.parentApp.myRisparmi.get_exchange_rate())
